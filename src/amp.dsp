...
gain		= db2linear(hslider("gain", 0, -96, 96, 0.1));
...
process = 
        hgroup("[0] clean", vgroup("[1] tone", tone, tone) : hgroup("[2] gain", (_*gain, _*gain)))
		: vgroup("balance", balance)
		: vgroup("[3] meter", (left_meter, right_meter));

// process = 
//          vgroup("[1] tone", (tone, tone))
//         : hgroup("[2] gain", (_*gain, _*gain))
// 		: vgroup("balance", balance)
// 		: vgroup("[3] meter", (left_meter, right_meter));
