 ...
 * component_phaser
 * 
 * just a wrapper for dm.phaser2_demo
 */
component_phaser = environment {

phaser_process = dm.phaser2_demo;  
...
fbp = 1-int(flsg(checkbox("Enable")));
// fbp = 1-int(flsg(hslider("[0] Enable [midi:ctrl 102][style:knob]",1,0,1,0.001)));

invert = flsg(checkbox("Invert"));
